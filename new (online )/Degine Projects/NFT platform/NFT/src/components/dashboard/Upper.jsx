    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-5 sm:p-6 rounded-3xl border border-slate-100 shadow-xs">
        ...
        <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
          ...
          <div className="flex items-center bg-purple-50/80 border border-purple-200/80 rounded-2xl p-1 shadow-2xs">
            <div className="px-3 py-1 text-xs font-mono font-semibold text-[#6F2CEE] max-w-[140px] sm:max-w-[200px] truncate">
              {referralLink}
            </div>
            <button
              onClick={handleCopyRef}
              className="bg-[#6F2CEE] hover:bg-purple-700 text-white px-3 py-1.5 rounded-xl font-bold text-xs flex items-center gap-1.5 shadow-2xs transition-all active:scale-95 cursor-pointer shrink-0"
            >
              {copiedRef ? (
                <>
            ...
            return (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2.5 pt-1">
                  <button className="py-2.5 px-3 bg-[#6F2CEE] hover:bg-purple-700 active:scale-95 text-white font-bold text-xs rounded-xl shadow-2xs transition-all cursor-pointer text-center flex items-center justify-center">
                    Deposit
                  </button>
