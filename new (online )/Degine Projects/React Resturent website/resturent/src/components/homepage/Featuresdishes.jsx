...
const Featuresdishes = () => {
  return (
    <div className="px-10 max-md:px-4">
      ...
      <div className="grid grid-cols-4 py-4 gap-2 max-md:grid-cols-1 text-gray-200">
        <div className="border  border-gray-500 rounded-md  ">
        <img src={pizza} className='rounded-t-md ' alt="" />
        ...
        <div className='flex justify-between px-4 py-2 items-center '>
          ...
          <button className='flex bg-orange-600 rounded-md  px-6 py-1'>Add <img src={add} className='w-6' alt="" /></button>
        </div>
